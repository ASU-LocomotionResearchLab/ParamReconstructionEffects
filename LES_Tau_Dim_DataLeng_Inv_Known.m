%=========================================================================%
%                   LES_Tau_Dim_DataLeng_Inv_Known.m
%
...
% gcSet = [30 50 100 150 200 300 500];
dpSet = [500 2000 5000 7500 10000 20000 30000 50000];

% Naming Conventions
% saveFilesNames = {'R_Lorenz_InvTauDim_dp'};
saveFilesNames = {'R_Rossler_InvTauDim_dp'};
dirNames = {'X'; 'Y'; 'Z'};
typeName = {'dp'};
...
finalSaveFileName = strcat(string(saveFilesNames), '_s', string(stSubj),'-',string(enSubj), '.mat');

switch string(typeName(type))
    % ========================================================================
    %  FOR GC & GCNORM DATA SETS 
    %
    % ========================================================================
    case {'gc', 'gcNorm'}
            ...
            for dir = 1:3 % VT;AP;ML (in order)
                ...
                for dp = 1:length(dpSet)
                    ...
                    if numPts > maxLeng
                        ...
                        % Extract desired time series
                        data = s(subj).v(dir).data(1:numPts);
                ...
                for dp = 1:length(dpSet)
                    ...
                    if numPts > maxLeng
                        ...
                        % Define taus to be tested: 1) that set's tau,
                        % 2) ideal tau: tau @dp = 10k; 3) arbTau defined at top
